...
def batch_thresholding(D, Y, epsilon):
    ...
    mat_inds = np.argsort(residual_sq, axis=0)  ## inner_product.shape
    ...
    accumulate_residual = np.cumsum(mat_sorted, axis=0)  ## inner_product.shape
